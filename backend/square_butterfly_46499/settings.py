"""
Django settings for square_butterfly_46499 project.
...
ROOT_URLCONF = 'square_butterfly_46499.urls'
...
WSGI_APPLICATION = 'square_butterfly_46499.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "square_butterfly_46499 API",
    "DESCRIPTION": "API documentation for square_butterfly_46499 App",
    "VERSION": "v1",
}
